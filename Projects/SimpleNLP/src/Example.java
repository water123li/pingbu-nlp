...
public class Example {
    ...
    public Example() {
        ...
        parser.addSlot("Year",
                Parser.compileLexicon("(<Digit:1800-2100>|前|去|旧|今|明|后)年[度]"));
        parser.addSlot(
                "Month",
                Parser.compileLexicon("[<Year>]<Digit:1-12>月[份]|(上上|上|这|下|下下)[个]月|本月"));
        ...
        parser.addSlot("Prefix",
                Parser.compileLexicon("[麻烦[你]]([请](帮|给|为)我)|我(想|要|想要)"));

        parser.addSlot("Category",
                Parser.compileLexicon("影视[剧]|电影|[影]片|[电视]剧|剧集|[电视]节目|动漫"));
        parser.addCommand("video", "[[<Prefix>]打开](搜视榜|点播[应用])");
        parser.addSlot("VideoAction",
                Parser.compileLexicon("(查|找|查找|搜[索]|打开|点播|看|播|放|播放)[[一]下]"));
        ...
        parser.addCommand("tvlive",
                "[[<Prefix>]([收]看]|播放)(电视|[电视]直播)|[[<Prefix>]打开]直播[应用]");
        parser.addCommand("tvlive",
                "[[<Prefix>]([收]看|打开|播放]<TVChannelCategory>[频道]");
        parser.addCommand("tvlive",
                "[[<Prefix>]([收]看|打开|播放)]<TVChannel>[[的|嘅]节目]");
        ...
        parser.addSlot("QueryAction", Parser
                .compileLexicon("(查|查询|查看|搜[索]|看|睇|问[你])[[一]下]|查查看|看看|问问看|问问你"));
        parser.addCommand("weather",
                "[[<Prefix>]<QueryAction>][<City>][<Date>][的|嘅]天气[情况|信息|怎[么]样|[还]好吗|好不好|可好]");
        ...
        parser.addCommand("stock",
                "[[<Prefix>](打开|查看)](股市|股票|沪市|上交所|深市|深交所|创业板)[大盘]");
        parser.addCommand("stock",
